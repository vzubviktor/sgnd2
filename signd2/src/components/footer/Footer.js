...
const Footer = () => {
    ...
    return <div className="footer bg-warning">
                <div className="container">
                    <div className="row centered">
                        ...
                        <a href="https://at.linkedin.com/in/viktor-zubchik-7a80b120b"><svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-file-person" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
