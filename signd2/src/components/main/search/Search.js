    ...
    return  <nav className="navbar navbar-light bg-warning">
              <form className="container-fluid">
                <a className="navbar-brand" href="https://github.com">
                    <img src="https://cdn-icons-png.flaticon.com/512/25/25231.png" alt="" width="24" height="24" className="d-inline-block align-text-top"></img>
                    GitHub Search 
                </a>
                  <div className="input-group">
                    <span className="input-group-text" id="basic-addon1">@</span>
                    <input className="form-control" value = {username } onChange = {e => setUsername(e.target.value)} type="search" placeholder="GitHub username" aria-label="Search"  aria-describedby="basic-addon1"></input>
